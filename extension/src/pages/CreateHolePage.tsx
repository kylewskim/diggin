...
const CreateHolePage: React.FC = () => {
  ...
  if (loading) {
    return (
      <div className="dark w-80 h-[400px] bg-surface-bg-light dark:bg-surface-bg-dark flex items-center justify-center">
  ...
  return (
    <div className="w-80 h-[400px] pt-8 bg-surface-bg-light dark:bg-surface-bg-dark inline-flex flex-col justify-start items-start overflow-hidden font-pretendard">
